...
class Norm():
    def __init__(self ,name: str, norm_type: NormType, condition_fn: Callable, activation_fn: Callable = None, 
                ...
                domain: Enum = 0, inviolable: bool = True, issuer: NormIssuer = NormIssuer.ORGANIZATION, promoting_values: list = [], demoting_values: list = []):
        '''
        ...
        self.issuer = issuer
        self.promoting_values = promoting_values
        self.demoting_values = demoting_values
