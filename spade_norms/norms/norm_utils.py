...
def add_single(norm_or_concern_db: dict, norm_or_concern: Norm):
    '''
...
def add_multiple(norm_or_concern_db: dict, norm_or_concern_list: list):
    '''
...
#TODO
def delete(norm_or_concern_db: dict, concern: Norm) -> bool:
    pass
